...
let white8 = "#000000";
let white9 = "#000000";
let bigbox = "green"; //หน้าของสี
let boxcolor = ""; // 
let id = ""; //ตัวเเปรเก็บค่าของ id
let color = "";
let clickedBoxId = null;
let clickedBoxColor = null;
let clickedBoxIds = []; // เก็บ ID ของช่องที่ถูกคลิก
...
const boxIds = ["box1", "box2", "box3", "box4", "box6", "box7", "box8", "box9"];
function setColor(color) { //ฟังชั่นสำหรับเซ็ทค่าสีที่เลือกในช่องถูกคลิ๊ก / เปลี่ยนหน้าของลูบิค
  clickedBoxColor = color;  //ให้ตัวเเปล clickedBoxColor รับค่าสีที่ถูกเลือก
  document.getElementById(clickedBoxId).style.backgroundColor = clickedBoxColor;
  if (clickedBoxId === "box5") {//ถ้าช่องที่ถูกคลิ๊กคือ 5
    if (clickedBoxColor === "#008000") { //ถ้าสีที่เลือกเป็นสีเขียว
      bigbox = "green";
      console.log("หน้าเขียว")
      const colors = [green1, green2, green3, green4, green6, green7, green8, green9];
      boxIds.forEach((boxId, index) => {
        document.getElementById(boxId).style.backgroundColor = colors[index];
      });
    } else if (clickedBoxColor === "#ffa500") {
      bigbox = "orang";
      console.log("หน้าส้ม")
      const colors = [orang1, orang2, orang3, orang4, orang6, orang7, orang8, orang9];
      boxIds.forEach((boxId, index) => {
        document.getElementById(boxId).style.backgroundColor = colors[index];
      });
      ...
      bigbox = "blue";
      console.log("หน้าฟ้า")
      const colors = [blue1, blue2, blue3, blue4, blue6, blue7, blue8, blue9];
      boxIds.forEach((boxId, index) => {
        document.getElementById(boxId).style.backgroundColor = colors[index];
      });
    } else if (clickedBoxColor === "#ff0000") {
      bigbox = "red";
      console.log("หน้าเเดง")
      const colors = [red1, red2, red3, red4, red6, red7, red8, red9];
      boxIds.forEach((boxId, index) => {
        document.getElementById(boxId).style.backgroundColor = colors[index];
      });
    } else if (clickedBoxColor === "#ffff00") {
      bigbox = "yellow";
      console.log("หน้าเหลือง")
      const colors = [yellow1, yellow2, yellow3, yellow4, yellow6, yellow7, yellow8, yellow9];
      boxIds.forEach((boxId, index) => {
        document.getElementById(boxId).style.backgroundColor = colors[index];
      });
      ...
      bigbox = "white";
      console.log("หน้าขาว")
      const colors = [white1, white2, white3, white4, white6, white7, white8, white9];
      boxIds.forEach((boxId, index) => {
        document.getElementById(boxId).style.backgroundColor = colors[index];
      });
    }
  } else if (colorMap[color]) {//เพิ่มค่าสีลงในตัวเเปรย่อย
    switch (bigbox) {
      case "green":
        switch (clickedBoxId) {
          case "box1":
...
/*************************************หลังจากนี้ของจริง**************************************/
//การเพิ่มข้อมูล
let all_output = " ";//ค่าที่จะส่งออก
let bigi = 1;//สูตรที่
//let boxbig = "";
function print() { 
  if (bigi === 1) {
    let w = 1;//หน้าที่1คือหน้าเขียว
    for (let stop1 = 0; stop1 < 8; stop1++) {
/*
    #00bfff  สีฟ้า
    #ffa500  สีส้ม
    #ffff00  สีเหลือง
    ...
    */
      ...
      //{
      if (green8 === "#008000" && white8 === "#ffffff" && w == 1) {
        w = 2;
      } else if (orang8 === "#008000" && white4 === "#ffffff" && w == 2) {
        w = 3;
      } else if (blue8 === "#008000" && white2 === "#ffffff" && w == 3) {
        w = 4;
      } else if (red8 === "#008000" && white6 === "#ffffff" && w == 4) {
        bigi = 2;
      }else if (green2 === "#008000" && yellow8 === "#ffffff" && w == 1) {
